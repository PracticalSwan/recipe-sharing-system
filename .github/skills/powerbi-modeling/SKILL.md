...
- User asks general data questions without Power BI context
- Request is for SQL queries or extraction only (no semantic modeling)
- Task doesn't involve DAX, relationships, or semantic modeling
- User wants basic visualization help without model design work
- Request targets other BI tools (Tableau, Qlik, etc.)
