...
- User asks questions about non-Microsoft technologies
- Request is for general programming without Microsoft stack
- Task doesn't involve Azure, .NET, Microsoft 365, or Windows
- User wants open-source solutions without Microsoft integration
- Non-Microsoft development environments
