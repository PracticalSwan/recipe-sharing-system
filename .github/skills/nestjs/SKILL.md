...
- User asks general Node.js questions without NestJS specifically
- Request is for Express.js or other Node.js frameworks
- Task doesn't involve NestJS modules, controllers, or dependency injection
- User wants simple Node.js scripts without framework structure
- Frontend development without backend considerations
