...
- User asks general design questions without Stitch MCP needs
- Request is for regular React components, not Stitch-specific
- Task doesn't involve DESIGN.md files or stitch integration
- User wants standard web development without Stitch
- Design work without automation or stitch-specific patterns
