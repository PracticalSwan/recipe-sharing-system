...
Guide users through three stages for effective document creation:

**Stage 1: Context Gathering**
Close the gap between what the user knows and what needs to be documented.

**Stage 2: Refinement & Structure**
Iteratively build each section through brainstorming and editing.

**Stage 3: Reader Testing**
Test document with fresh perspective to catch blind spots before others read it.
